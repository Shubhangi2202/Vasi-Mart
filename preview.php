...
<div class="content" id="content">
	<div style="margin: 0 auto; padding: 20px; width: 700px; font-weight: normal;">
		<div style="width: 100%; height: 190px;">
			<div style="width: 459px; float: left;">
				<div style="text-align: center; font-size: 19px; margin: 40px 0;"> Vasi Mart Ayurvedic Cosmetics and Skincare Products
				</div>


				Contact No :1234567890/987654 Telesom<br>
				Email Address : vasimart@gmail.com<br>
				<div>
					<?php
					...
					<tr>
						...
						<td colspan="2"><strong style="font-size: 12px; color: #222222;">
								...
								function formatMoney($number, $fractional = false)
								{
									...
									while (true) {
										$replaced = preg_replace('/(-?\d+)(\d\d\d)/', '₹0,₹1', $number);
										if ($replaced != $number) {
											$number = $replaced;
										} else {
											break;
	...
	<div align=center>THANK YOU FOR YOUR SHOPPING AT Vasi Mart Ayurvedic Cosmetics and Skincare Products COME AGAIN PLEASE !!!!</div>
	<div style="text-align: center; font-size: 20px; margin: 30px 0; color: red"> save your money by using Point Of Sale (POS)-designed by A.rahman Osman Sh.farah (contac#:4188000)
	</div>