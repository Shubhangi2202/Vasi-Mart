	...
	<div id="wrapper">
		...
		<div id="main" class="shell">
			...
			<div id="content">
				...
				<div id="kcontent">
					<h1> Vasi Mart Payment Method</h1>
					<div id="wwrapper">
						<div id="steps">
							...
							<form id="formElem" name="formElem" action="InsertPayment.php" method="POST" class="myForm">
								...
								<fieldset class="step">
									...
									<p>
										...
										<input id="email" name="email" placeholder="shubhangi@gmail.com" type="email" AUTOCOMPLETE=OFF />
									</p>
									<p>
								...
								<fieldset class="step">
									...
									<p>
										Remember Sir / Ma'am If You Proceed it Now You Can Find Your Sales Voucher Or Payment Voucher In Your Mail Box In A View Minutes.
									</p>
									<p class="submit">
			...
			<div id="sidebar">
				<ul>
					<li class="widget">
						...
						<div class="brands">
							<ul>
								<li><a href="#" title="Brand 1"><img src="../images/jj.png" alt="Brand 1" /></a></li>
								<li><a href="#" title="Brand 2"><img src="../images/nn.png" alt="Brand 2" /></a></li>
								<li><a href="#" title="Brand 3"><img src="../images/pp.png" alt="Brand 3" /></a></li>
								<li><a href="#" title="Brand 4"><img src="../images/dd.png" alt="Brand 4" /></a></li>
							</ul>
							<div class="cl">&nbsp;</div>
						</div>
			...
			<div class="post">
				...
				<p>Welcome to the Vasi Mart Payment System </p>
				<div class="cl">&nbsp;</div>
			</div>
		</div>
		<!-- End Main -->
		...
		<div class="boxes">
			...
			<div class="copy">
				...
				<div class="shell">
					...
					<p align="center">&copy; Vasi Mart <a href="index.php"><i>
								<font color="fefefe"> Welcome To <strong> Vasi Mart</strong> Online Shopping Site </font>
							</i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
