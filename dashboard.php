	...
	<div id="container">
		...
		<div id="header">
			...
			<div id="logo-banner">
				...
				<div id="logo">
					...
					<a href="index.php"><img src="images/logo1.png" alt="" height="100" width="260" /></a>
				</div>
		...
		<div id="content-wrap">
			...
			<aside id="sidebar" class="column">
				...
				<!-- End Search -->
				<hr />
				<h3> Vasi Mart Database Backup:</h3>
				<ul class="toggle">
			...
			<section id="main" class="column">
				...
				<h4 class="alert_info">Welcome To <strong>"Vasi Mart"</strong> Admin Panel As: <?php echo "  " . "<font color='#f90'><big><b>" . $login_session . "</b></big></font>"; ?> </h4>
				...
				<div id="tab2" class="tab_content">
					...
					<table class="tablesorter" cellspacing="0">
						<thead>
							<thead>
								<th colspan="7"> Commands and Complain </th>
							</thead>
							<thead>
								</tr>
								<th>Check</th>
