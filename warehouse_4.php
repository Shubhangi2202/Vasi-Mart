		...
		<div id="footer">
			...
			<div class="copy">
				...
				<div class="shell">
					...
					<div class="cl">&nbsp;</div>
					Copyright © 2021 Vasi Mart All rights reserved. The information contained in Vasi Mart may not be published, broadcast, rewritten, or redistributed without the prior written authority of Vasi Mart
				</div>
				<!-- End Shell -->
			</div>
		</div>
