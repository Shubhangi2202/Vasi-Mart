	...
	<div id="main" class="shell">
		...
		<div class="viewcart">
			...
			if (isset($_SESSION["cart_session"])) {
				...
				echo '<spa class="midigta"><a  class="a-btn" href="Somstore checkout/zaadprocess.php"><span class="a-btn-text">Pay through UPI or Online Payments Method
</span> </a></span>';

				echo '<span class="midigta"> <a  class="a-btn" href="Somstore checkout/process.php"> <span class="a-btn-text"> Pay through Cash on Delivery</span></a></span>';
				echo '</span>';
				echo '</form>';
			} else {
		...
		<div id="content">
			<div class="post">
				...
				<img src="images/logo1.png" alt="Post Image" height="120" width="260" />
