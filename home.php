...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="Suncart">Vasi Mart</a></h1>
				<div id="top-nav">
					<ul>
		...
		<div id="slider">
			...
			<div class="shell">
				<ul class="slider-items">
					<li>
						<img src="images/s11.png" alt="Slide Image" />

					</li>
					<li>
						<img src="images/s12.png" alt="Slide Image" />

					</li>
					<li>
						<img src="images/s13.png" alt="Slide Image" />

					</li>
					<li>
						<img src="images/s14.png" alt="Slide Image" />

					</li>
					<li>
						<img src="images/s15.png" alt="Slide Image" />

					</li>
					<li>
						<img src="images/s16.png" alt="Slide Image" />

					</li>
					<li>
						<img src="images/s17.png" alt="Slide Image" />

					</li>
					<li>
						<img src="images/s18.png" alt="Slide Image" />

					</li>
					<li>
						<img src="images/s19.png" alt="Slide Image" />
		...
		<div id="main" class="shell">
			...
			<div id="content">
				<div class="post">
					...
					The purpose of these e-commerce arrangements is to facilitate artefacts lovers to ease their shopping experience by buying products made by various tribes of India while sitting at their homes. Besides, ensuring genuine and authentic tribal products for artefacts lovers at their door steps, the online portals also promote Tribes India as a brand for tribal products.
			...
			<div class="boxes">
				...
				<div class="shell">
					<div class="box post-box">
						...
						<div class="box-entry">
							<img src="images/logo1.png" alt="SomStore" width="120" height="60" />
			...
			<div class="copy">
				...
				<div class="shell">
					...
					<p>&copy; Vasi Mart <a href="index.php"><i>
								<font color="fefefe"> Welcome to the Vasi Mart Store </font>
							</i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
