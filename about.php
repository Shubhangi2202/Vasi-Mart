...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="MarketPlace">Vasi Mart</a></h1>
				<div id="top-nav">
					<ul>
				...
				<ul>
					...
					<li>
						...
						<div class="dd">
							<ul>
								<li>
									 <a href="products.php">Textiles</a>
									<div class="dd">
										<ul>
											<li><a href="products.php">Mens</a></li>
                                            <li><a href="products.php">Womens</a></li>
										</ul>
									</div>
								</li>
								
								<li>
									 <a href="products.php">Handicrafts</a>
									<div class="dd">
										<ul>
											  <li><a href="products.php">Craft</a></li>
								...
								<li>
									<a href="products.php">Gifts & Novelties</a>
									<div class="dd">
										<ul>
											<li><a href="products.php">Gifts</a></li>
                                            <li><a href="products.php">Novelties</a></li>
										</ul>
									</div>
								</li>
								
								<li>
									<a href="products.php">Jewelry</a>
									<div class="dd">
										<ul>
											  <li><a href="products.php">Dokhra</a></li>
...
.. <a href="#" class="more" title="Read More">Read More</a></p>
				...
				<div class="post">
					...
					<p>Shubhangi, Manasi Bobde & Ruchika Bhaganagarkar </p>
...
<!-- Begin Sidebar -->
   ...
   <input name="shout_message" id="shout_message" type="text" placeholder="Type Message Hit Enter" maxlength="100" /> 
					...
					</div>	<p align="center">&copy; Vasi Mart <a href="index.php"><i><font color="fefefe"> Welcome To <strong> Vasi Mart</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
